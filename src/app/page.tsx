    ...
    <div className="min-h-screen bg-[#0a0a0f]">
        ...
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex flex-col gap-0.5">
            ...
            <p className="text-xs text-[#71717a] tracking-wide">
              DOCK50–DOCK72 &nbsp;|&nbsp; September 16, 2026 &nbsp;|&nbsp; Last refreshed: Sep 16 ~11:44 PDT
            </p>
          </div>
          {/* Facility badge */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-[#a1a1aa] mt-1">
                  <strong>DOCK53:</strong> TASK-5368697 (LOAD, IN_PROGRESS, 20h 23m)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK54:</strong> TASK-5338695 (LOAD, ⚠ STALE, 39d 19h 15m)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK50:</strong> TASK-5368207 (RECEIVE, IN_PROGRESS, 24h 19m — KARAKA)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK54:</strong> TASK-5364490 (RECEIVE, IN_PROGRESS, 19h 21m — KARAKA)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK56:</strong> TASK-5369422 (RECEIVE, IN_PROGRESS, 0h 22m — KARAKA)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK56:</strong> TASK-5369120 (RECEIVE, NEW — KARAKA)
                </span>
                <span className="text-xs text-[#71717a] mt-1 italic">
                  Total: 6 tasks (2 LOAD + 4 RECEIVE). 2 GURUNANDA + 4 KARAKA. No other open Bay-4 task is assigned to Arnulfo. All-time (carried): 913 at Bay-4 doors (912 LOAD + 1 RECEIVE).
                </span>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-[#a1a1aa] mt-1">
                  <span className="text-[#f59e0b] font-semibold">ARNULFO MUNGUIA:</span> 6 open (2 LOAD — DOCK53, DOCK54 STALE; 4 RECEIVE — DOCK50, DOCK54, DOCK56 ×2)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#22c55e] font-semibold">CANDY MENDEZ:</span> 6 open (RECEIVE, all NEW — DOCK54 ×2, DOCK56, DOCK57, DOCK58, DOCK59)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#7c3aed] font-semibold">DANIEL BELTRAN:</span> 1 open (LOAD — DOCK57, 0h 20m)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#22c55e] font-semibold">EFREN SALVADOR:</span> 1 open (LOAD — DOCK58, 0h 16m)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#7c3aed] font-semibold">JORGE ANTONIO FRANCO:</span> 1 open (RECEIVE — DOCK62, 1d 20h 59m)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#f59e0b] font-semibold">RUFINO MUNGUIA:</span> 1 open (RECEIVE — DOCK71, 1h 25m)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#22c55e] font-semibold">JEROME ARANDA:</span> 1 open (RECEIVE — DOCK55, NEW)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#ef4444] font-semibold">daira gonzalez:</span> 1 open (RECEIVE — DOCK50, 329d 22h 23m ⚠)
                </span>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-[#a1a1aa] mt-1">
                  <span className="text-[#7c3aed] font-semibold">GURUNANDA, LLC (ORG-655875):</span> 13 tasks (72.2% of open)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#22c55e] font-semibold">KARAKA, LLC (ORG-585450):</span> 5 tasks (27.8%)
                </span>
        ...
        <section>
          <div className="bg-[#141419] border border-[#1e1e2a] rounded-xl p-5 flex flex-col gap-2">
            ...
            <ul className="text-xs text-[#71717a] space-y-1 list-disc list-inside">
              <li><strong className="text-[#f4f4f6]">8 Occupied / 2 Reserved / 13 Available</strong> — door utilization is task-derived at the 2026-09-16 ~11:44 PDT snapshot: 8 doors with an in-progress open task (DOCK50, DOCK53, DOCK54, DOCK56, DOCK57, DOCK58, DOCK62, DOCK71), 2 doors holding only a not-started NEW task (DOCK55, DOCK59), 13 doors with no open load/receive task. 10 doors carry an active assignment (43.5%). (Location API dockStatus remains unreliable — it reports far more Bay-4 doors OCCUPIED; task-derived status is authoritative.)</li>
              <li>Open tasks: <strong className="text-[#7c3aed]">4 outbound (LOAD)</strong> / <strong className="text-[#22c55e]">14 inbound (RECEIVE)</strong> = 18 at ~11:44 PDT. 22.2% outbound / 77.8% inbound. All 18 are on Bay-4 doors; the open population was read exhaustively (every one of the 23 Bay-4 doors swept individually for open load tasks and open receive tasks).</li>
              <li><strong className="text-[#7c3aed]">Customer mix:</strong> 13 of the 18 open Bay-4 tasks are GURUNANDA, LLC (ORG-655875) — 72.2%; the other 5 are KARAKA, LLC (ORG-585450) — DOCK50 TASK-5368207, DOCK54 TASK-5364490, DOCK55 TASK-5368665, DOCK56 TASK-5369422, DOCK56 TASK-5369120. Task status: 10 IN_PROGRESS + 8 NEW.</li>
              <li><strong className="text-[#ef4444]">SEVERE ANOMALY — DOCK50 (aging 329d 22h 23m):</strong> TASK-5090739 RECEIVE remains IN_PROGRESS with endTime already set (2025-10-22) — stuck/stale and still aging. Assigned to daira gonzalez. Investigate immediately.</li>
              <li><strong className="text-[#f59e0b]">ANOMALY — DOCK54 (aging 39d 19h 15m):</strong> TASK-5338695 (LOAD) remains IN_PROGRESS with endTime already set (2026-08-10) — stale — while the same door also carries ARNULFO MUNGUIA&apos;s live KARAKA RECEIVE TASK-5364490 plus two NEW GURUNANDA receives (TASK-5369404, TASK-5369031) — four open tasks on one door.</li>
              <li><strong className="text-[#f59e0b]">Two open receive tasks on DOCK50:</strong> TASK-5368207 (RECEIVE IN_PROGRESS, 24h 19m, KARAKA — receipts RN-192099 / RN-192101) and TASK-5090739 (RECEIVE IN_PROGRESS, 329d 22h 23m, GURUNANDA — receipt RN-5002143) — different receipts, two assignees, one door.</li>
              <li><strong className="text-[#22c55e]">Schedule % (today, 2026-09-16 — Wednesday, facility-wide, ~11:44 PDT):</strong> scheduled inbounds received <strong className="text-[#f4f4f6]">{scheduledInboundReceived} of {scheduledInboundOrders} = {pctScheduledInboundReceived.toFixed(1)}%</strong> (receipts whose binding appointmentTimeFrom/To window falls on 2026-09-16, CLOSED = received); scheduled outbound loads loaded <strong className="text-[#f4f4f6]">{scheduledOutboundLoaded} of {scheduledOutboundOrders} = {pctScheduledOutboundLoaded.toFixed(1)}%</strong> (loads whose binding appointmentTimePeriod falls on 2026-09-16; 25 SHIPPED + 1 LOADED). Both denominators are non-zero this refresh, so both percentages are reported live. Control: the 2026-09-15 receipt window returns 58, matching the prior snapshot.</li>
              ...
              <li><strong className="text-[#f59e0b]">TIMESTAMP BASIS — durations aged task startTime → snapshot instant:</strong> task timestamps are read on the same UTC frame as the snapshot instant (2026-09-16T18:44:00Z), exactly as in every prior snapshot, so the aged durations stay comparable across refreshes.</li>
      ...
      <footer className="border-t border-[#1e1e2a] bg-[#0a0a0f] mt-2">
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between text-xs text-[#71717a]">
          ...
          <span>Last refreshed: September 16, 2026 ~11:44 PDT</span>
        </div>
      </footer>
    </div>
  );
