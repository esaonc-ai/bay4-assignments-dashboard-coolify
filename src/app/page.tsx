    ...
    <div className="min-h-screen bg-[#0a0a0f]">
        ...
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex flex-col gap-0.5">
            ...
            <p className="text-xs text-[#71717a] tracking-wide">
              DOCK50–DOCK72 &nbsp;|&nbsp; September 20, 2026 &nbsp;|&nbsp; Last refreshed: Sep 20 ~12:27 PDT
            </p>
          </div>
          {/* Facility badge */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-[#a1a1aa] mt-1">
                  <strong>DOCK54:</strong> TASK-5372101 (LOAD, IN_PROGRESS, 1d 21h 58m — GURUNANDA)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK54:</strong> TASK-5365421 (LOAD, ⚠ STALE, 9d 2h 55m — GURUNANDA)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK54:</strong> TASK-5338695 (LOAD, ⚠ STALE, 43d 19h 58m — GURUNANDA)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK54:</strong> TASK-5364490 (RECEIVE, IN_PROGRESS, 4d 20h 4m — KARAKA)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK62:</strong> TASK-5365814 (RECEIVE, IN_PROGRESS, 5d 21h 43m — GURUNANDA)
                </span>
                <span className="text-xs text-[#a1a1aa]">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#ef4444] font-semibold">daira gonzalez:</span> 1 open (RECEIVE — DOCK50, 333d 23h 6m ⚠)
                </span>
                <span className="text-xs text-[#a1a1aa]">
        ...
        <section>
          <div className="bg-[#141419] border border-[#1e1e2a] rounded-xl p-5 flex flex-col gap-2">
            ...
            <ul className="text-xs text-[#71717a] space-y-1 list-disc list-inside">
              ...
              <li><strong className="text-[#ef4444]">SEVERE ANOMALY — DOCK50 (aging 333d 23h 6m):</strong> TASK-5090739 RECEIVE remains IN_PROGRESS with endTime already set (2025-10-22) — stuck/stale and still aging. Assigned to daira gonzalez. Investigate immediately.</li>
              <li><strong className="text-[#f59e0b]">ANOMALY — DOCK54 (aging 43d 19h 58m and 9d 2h 55m):</strong> TASK-5338695 (LOAD) and TASK-5365421 (LOAD) both remain IN_PROGRESS with endTime already set (2026-08-10 and 2026-09-11) — stale — on a door that also carries two live receive tasks (TASK-5369031 GURUNANDA, TASK-5364490 KARAKA) for five open tasks on one door.</li>
              <li><strong className="text-[#22c55e]">Live churn during this pull:</strong> none observed — the open population was stable across the whole window (facility-wide 34 load / 132 receive and Bay-4 15 tasks on both the opening read at 2026-09-20T19:26:15Z and the closing sweep at 2026-09-20T19:27:58Z). All figures on this page come from that one tight, self-consistent final sweep.</li>
              ...
              <li><strong className="text-[#f59e0b]">TIMESTAMP BASIS — durations aged task startTime → snapshot instant:</strong> task timestamps are read on the same UTC frame as the snapshot instant (2026-09-20T19:27:58Z). Query window 2026-09-20T19:26:15Z → 2026-09-20T19:27:58Z.</li>
      ...
      <footer className="border-t border-[#1e1e2a] bg-[#0a0a0f] mt-2">
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between text-xs text-[#71717a]">
          ...
          <span>Last refreshed: September 20, 2026 ~12:27 PDT</span>
        </div>
      </footer>
    </div>
  );
