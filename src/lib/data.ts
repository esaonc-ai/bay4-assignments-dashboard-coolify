 ...
 *
 * TASK DATA: Refreshed 2026-09-20 ~12:27 PDT (live WISE/WMS APIs)
 *   Sources:
 ...
 *
 * SNAPSHOT INSTANT: 2026-09-20 12:27 PDT (America/Los_Angeles), Sunday.
 * UTC QUERY WINDOW: 2026-09-20T19:26:15Z → 2026-09-20T19:27:58Z (snapshot instant 2026-09-20T19:27:58Z).
 ...
 *
 * SCHEDULE-FILTER NOTE (unchanged, re-verified):
 *   - LOADS bind on `appointmentTimePeriod` (a BETWEEN requiring exactly two date-time elements).
 *   - RECEIPTS bind on `appointmentTimeFrom` / `appointmentTimeTo` (inclusive window).
 ...
 *
 * DOOR FILTER NOTE: on the task-search family the door filter binds ONLY as the singular `dockId`;
 *   a plural `dockIds` (array) is silently IGNORED and a comma-separated `dockId` string is rejected
 *   (HTTP 400). The Bay-4 population was therefore taken from a full facility-wide open sweep and
 *   filtered on each row's `dockId`. Door ids are NOT sequential: 23/23 live-verified this refresh
 *   (totalCount = 23): DOCK50=570, 51=554, 52=556, 53=552, 54=564, 55=560, 56=575, 57=563, 58=572,
 *   59=571, 60=565, 61=567, 62=566, 63=568, 64=559, 65=573, 66=576, 67=577, 68=574, 69=578, 70=579,
 *   71=580, 72=587.
 *
 ...
 *   durations are aged startTime → 2026-09-20T19:27:58Z.
 */
...
export const refreshStamp = "Sep 20 ~12:27 PDT";
export const refreshDateLong = "September 20, 2026";
// UTC query window for this snapshot
export const snapshotUtc = "2026-09-20T19:27:58Z";
export const windowUtc = "2026-09-20T19:26:15Z → 2026-09-20T19:27:58Z";

export const doors: DoorRecord[] = [
  // OCCUPIED — door has at least one in-progress open task (5 doors)
  { door: "DOCK50", status: "Occupied", assignee: "daira gonzalez / DANIEL BELTRAN", customer: "GURUNANDA, LLC", taskIds: ["TASK-5090739", "TASK-5372145"], duration: "333d 23h 6m", anomaly: true },
  { door: "DOCK54", status: "Occupied", assignee: "ARNULFO MUNGUIA / CANDY MENDEZ", customer: "GURUNANDA, LLC / KARAKA, LLC", taskIds: ["TASK-5338695", "TASK-5364490", "TASK-5365421", "TASK-5369031", "TASK-5372101"], duration: "43d 19h 58m", anomaly: true },
  { door: "DOCK57", status: "Occupied", assignee: "DANIELA GONZALEZ", customer: "GURUNANDA, LLC", taskIds: ["TASK-5371234", "TASK-5371291"], duration: "2d 16h 16m", anomaly: false },
  { door: "DOCK60", status: "Occupied", assignee: "RUFINO MUNGUIA", customer: "GURUNANDA, LLC", taskIds: ["TASK-5371839", "TASK-5371932"], duration: "1d 22h 18m", anomaly: false },
  { door: "DOCK62", status: "Occupied", assignee: "ARNULFO MUNGUIA", customer: "GURUNANDA, LLC", taskIds: ["TASK-5365814"], duration: "5d 21h 43m", anomaly: false },
...
// the 2026-09-20 ~12:27 PDT snapshot: 4 LOAD + 11 RECEIVE on 7 doors, 7 distinct assignees)
...
// FULLY RECOMPUTED this refresh (2026-09-20 ~12:27 PDT) from a complete row-level rescan of all
...
export const allTimeLastRecomputed = "2026-09-20 ~12:27 PDT";
...
// appointmentTimeFrom/To. Both return 0 for 2026-09-20 — no loads and no receipts carry an
// appointment time on this day, so the two percentages have a zero denominator and are reported as
...
export const nextDayReceiptsReceived = 0; // of 46

export const doorDurationsAvailable = true;

// Open task records from fresh WISE data (Sep 20, 2026 ~12:27 PDT snapshot)
// 15 open tasks: 4 LOAD (outbound) + 11 RECEIVE (inbound)
export const assignments: TaskRecord[] = [
  { taskId: "TASK-5090739", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (333d 23h 6m) ⚠ STALE", assignee: "daira gonzalez", door: "DOCK50" },
  { taskId: "TASK-5372145", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 21h 25m)", assignee: "DANIEL BELTRAN", door: "DOCK50" },
  { taskId: "TASK-5338695", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (43d 19h 58m) ⚠ STALE", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  { taskId: "TASK-5364490", dns: "RECEIVE IN_PROGRESS", customer: "KARAKA, LLC", pieces: "IN_PROGRESS (4d 20h 4m)", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  { taskId: "TASK-5365421", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (9d 2h 55m) ⚠ STALE", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  { taskId: "TASK-5369031", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 21h 56m)", assignee: "CANDY MENDEZ", door: "DOCK54" },
  { taskId: "TASK-5372101", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 21h 58m)", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  ...
  { taskId: "TASK-5371234", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 20h 52m)", assignee: "DANIELA GONZALEZ", door: "DOCK57" },
  { taskId: "TASK-5371291", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (2d 16h 16m)", assignee: "DANIELA GONZALEZ", door: "DOCK57" },
  { taskId: "TASK-5371839", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 22h 18m)", assignee: "RUFINO MUNGUIA", door: "DOCK60" },
  { taskId: "TASK-5371932", dns: "RECEIVE NEW", customer: "GURUNANDA, LLC", pieces: "NEW — not started", assignee: "RUFINO MUNGUIA", door: "DOCK60" },
  { taskId: "TASK-5365814", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (5d 21h 43m)", assignee: "ARNULFO MUNGUIA", door: "DOCK62" },
];
