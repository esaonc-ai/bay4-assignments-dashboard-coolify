...
export const refreshStamp = "Sep 06 ~14:45 PDT";
...
// FRESH rollup 2026-09-06 ~14:45 PDT — rescanned CLOSED/FORCE_CLOSED load + receive tasks
// across all 23 Bay-4 door IDs (3,639 closed tasks total: 2,718 LOAD + 921 RECEIVE, 80 assignees)
// — identical to the 09-05 19:04 PDT, 09-06 11:30 PDT, 09-06 12:20 PDT and 09-06 13:20 PDT
//   rollups (no Bay-4 closures in the window; newest closed task endTime =
//   2026-09-05T06:13:25Z = 09-04 23:13 PDT — re-verified at ~14:45 PDT)
...
// loads → both % are n/a (no denominators). Endpoint verified live on 09-06 ~14:45 PDT.
...
// Today’s facility-wide context (2026-09-06, ~14:45 PDT)
...
//   NEW — createdTime 2026-09-06T07:37:59Z = 00:37:59 PDT Sep 6 — same load as the ~13:20 PDT
//   snapshot; no LOADING loads created today (25 LOADING facility-wide, all older))
...
// Open task records from fresh WISE data (Sep 06, 2026 ~14:45 PDT)
// 8 open tasks: 6 LOAD (outbound) + 2 RECEIVE (inbound) — same set as the 09-06 13:20 PDT
// snapshot (no task opened, closed, or moved doors in the window; ages advanced ~1h25m)
export const assignments: TaskRecord[] = [
  ...
  },
  {
    ...
    dns: "LOAD IN_PROGRESS",
    customer: "GURUNANDA, LLC",
    pieces: "IN_PROGRESS (29d 22h) ⚠ STALE",
    assignee: "ARNULFO MUNGUIA",
    door: "DOCK54",
  },
  {
