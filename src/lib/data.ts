 ...
 *
 * TASK DATA: Refreshed 2026-09-13 07:07:00 PDT (live WISE/WMS APIs)
 *   Sources:
 ...
 *     - /wms-bam/inbound/receipt/search-by-paging — customer names (ORG-585450, ORG-655875)
 *
 * SNAPSHOT INSTANT: 2026-09-13 07:07:00 PDT (America/Los_Angeles), Sunday.
 * UTC QUERY WINDOW: 2026-09-13T14:07:02Z → 2026-09-13T14:07:27Z.
 ...
 *   queries. `dockId` binds as a string id on both task searches. Door ids are NOT sequential —
 *   live-verified this refresh: DOCK50=570, 51=554, 52=556, 53=552, 54=564, 55=560, 56=575, 57=563,
 ...
 *   de-duplicated by task id. No rows were fabricated; every value below is a live count.
 *
 *   FILTER NOTE: the customer filter on the load/receive task searches binds ONLY as the ARRAY
 *   parameter `customerIds`. The singular `customerId` is silently IGNORED by the API.
 *
 *   TIMESTAMP NOTE: the API returns UTC wall-clock timestamps; durations are aged from task
 *   startTime (UTC) to the snapshot instant, the same basis as every prior snapshot, so they remain
 *   comparable across snapshots.
 *
 * DELTA vs 2026-09-12 16:35 PDT snapshot: NO population change in any figure — doors 7 occupied /
 ...
 *   is elapsed time: durations aged ~14h32m (e.g. DOCK72 19h 27m → 1d 09h 59m; DOCK50 326d 03h 13m →
 *   326d 17h 45m). Today (Sun 2026-09-13) has no scheduled receipt/load appointment population.
 */
...
export const refreshStamp = "Sep 13 ~07:07 PDT";
export const refreshDateLong = "September 13, 2026";
// UTC query window for this snapshot
export const snapshotUtc = "2026-09-13T14:07:02Z";
export const windowUtc = "2026-09-13T14:07:02Z → 2026-09-13T14:07:27Z";

export const doors: DoorRecord[] = [
  // OCCUPIED — door has an in-progress open task (7 doors)
  { door: "DOCK50", status: "Occupied", assignee: "daira gonzalez", customer: "GURUNANDA, LLC", taskIds: ["TASK-5090739"], duration: "326d 17h 45m", anomaly: true },
  { door: "DOCK51", status: "Occupied", assignee: "ARNULFO MUNGUIA / EDUARDO MEJIA", customer: "GURUNANDA, LLC", taskIds: ["TASK-5366005", "TASK-5365623"], duration: "1d 17h 47m", anomaly: false },
  { door: "DOCK53", status: "Occupied", assignee: "BARTOLO RAMIREZ / CANDY MENDEZ", customer: "GURUNANDA, LLC", taskIds: ["TASK-5365768", "TASK-5365522"], duration: "1d 17h 08m", anomaly: false },
  { door: "DOCK54", status: "Occupied", assignee: "ARNULFO MUNGUIA", customer: "GURUNANDA, LLC / KARAKA, LLC", taskIds: ["TASK-5338695", "TASK-5364490"], duration: "36d 14h 37m", anomaly: true },
  { door: "DOCK55", status: "Occupied", assignee: "JULIO CESAR ALVARADO / JEROME ARANDA", customer: "GURUNANDA, LLC", taskIds: ["TASK-5331094", "TASK-5365675", "TASK-5365676"], duration: "44d 19h 33m", anomaly: true },
  { door: "DOCK62", status: "Occupied", assignee: "RUFINO MUNGUIA / JORGE ANTONIO FRANCO", customer: "GURUNANDA, LLC", taskIds: ["TASK-5365827", "TASK-5365814"], duration: "1d 16h 50m", anomaly: false },
  { door: "DOCK72", status: "Occupied", assignee: "DANIELA GONZALEZ", customer: "GURUNANDA, LLC", taskIds: ["TASK-5366063"], duration: "1d 09h 59m", anomaly: false },
...
// the 2026-09-13 07:07:00 PDT snapshot: 5 LOAD + 8 RECEIVE on 7 doors, 10 distinct assignees)
...
// RE-VERIFIED LIVE in this refresh (2026-09-13T14:07:02Z → 14:07:27Z) — rows == totalCount asserted
// on all 23 doors, both task types; 2,763 LOAD + 947 RECEIVE = 3,710 closed transactions. Unchanged
// vs the 2026-09-12 16:35 PDT snapshot.
...
// refresh (2026-09-13 07:07:00 PDT). (The receive row on a Bay-4 door is TASK-5197246, DOCK69.)
...
// Mix: 5 LOAD (outbound) + 8 RECEIVE (inbound) = 13 open tasks at Bay 4 doors (2026-09-13 07:07:00
// PDT snapshot) — unchanged vs the 2026-09-12 16:35 PDT snapshot (13 open, 5 LOAD + 8 RECEIVE).
...
// load status LOADED+SHIPPED (loaded). Queried live ~07:07 PDT.
...
// Open task records from fresh WISE data (Sep 13, 2026 07:07:00 PDT snapshot)
// 13 open tasks: 5 LOAD (outbound) + 8 RECEIVE (inbound)
export const assignments: TaskRecord[] = [
  { taskId: "TASK-5090739", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (326d 17h 45m) ⚠ STALE", assignee: "daira gonzalez", door: "DOCK50" },
  { taskId: "TASK-5366005", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 12h 50m)", assignee: "EDUARDO MEJIA", door: "DOCK51" },
  { taskId: "TASK-5365623", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 17h 47m)", assignee: "ARNULFO MUNGUIA", door: "DOCK51" },
  { taskId: "TASK-5365768", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 17h 08m)", assignee: "BARTOLO RAMIREZ", door: "DOCK53" },
  { taskId: "TASK-5365522", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 15h 43m)", assignee: "CANDY MENDEZ", door: "DOCK53" },
  { taskId: "TASK-5338695", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (36d 14h 37m) ⚠ STALE", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  { taskId: "TASK-5364490", dns: "RECEIVE NEW", customer: "KARAKA, LLC", pieces: "NEW — not started", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  { taskId: "TASK-5331094", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (44d 19h 33m) ⚠ STALE", assignee: "JULIO CESAR ALVARADO", door: "DOCK55" },
  { taskId: "TASK-5365675", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 17h 59m) — RN-5010237", assignee: "JEROME ARANDA", door: "DOCK55" },
  ...
  { taskId: "TASK-5365827", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 16h 50m)", assignee: "RUFINO MUNGUIA", door: "DOCK62" },
  ...
  { taskId: "TASK-5366063", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1d 09h 59m)", assignee: "DANIELA GONZALEZ", door: "DOCK72" },
];
