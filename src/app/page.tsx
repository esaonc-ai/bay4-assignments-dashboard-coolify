    ...
    <div className="min-h-screen bg-[#0a0a0f]">
        ...
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex flex-col gap-0.5">
            ...
            <p className="text-xs text-[#71717a] tracking-wide">
              DOCK50–DOCK72 &nbsp;|&nbsp; September 16, 2026 &nbsp;|&nbsp; Last refreshed: Sep 16 ~18:21 PDT
            </p>
          </div>
          {/* Facility badge */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-[#a1a1aa] mt-1">
                  <strong>DOCK53:</strong> TASK-5369859 (LOAD, IN_PROGRESS, 3h 31m)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK54:</strong> TASK-5338695 (LOAD, ⚠ STALE, 40d 1h 52m)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK50:</strong> TASK-5368207 (RECEIVE, ⚠ STALE, 1d 6h 56m — KARAKA)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <strong>DOCK54:</strong> TASK-5364490 (RECEIVE, IN_PROGRESS, 1d 1h 58m — KARAKA)
                </span>
                <span className="text-xs text-[#a1a1aa]">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-[#a1a1aa] mt-1">
                  <span className="text-[#f59e0b] font-semibold">DANIELA GONZALEZ:</span> 6 open (RECEIVE — DOCK55, DOCK56, DOCK66, DOCK71 NEW; DOCK57, DOCK70 IN_PROGRESS)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                ...
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#22c55e] font-semibold">JORGE ANTONIO FRANCO:</span> 1 open (RECEIVE — DOCK62, 2d 3h 36m)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#7c3aed] font-semibold">JEROME ARANDA:</span> 1 open (RECEIVE — DOCK55, NEW)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#ef4444] font-semibold">daira gonzalez:</span> 1 open (RECEIVE — DOCK50, 330d 5h 0m ⚠)
                </span>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-[#a1a1aa] mt-1">
                  <span className="text-[#7c3aed] font-semibold">GURUNANDA, LLC (ORG-655875):</span> 15 tasks (78.9% of open)
                </span>
                <span className="text-xs text-[#a1a1aa]">
                  <span className="text-[#22c55e] font-semibold">KARAKA, LLC (ORG-585450):</span> 4 tasks (21.1%)
                </span>
        ...
        <section>
          <div className="bg-[#141419] border border-[#1e1e2a] rounded-xl p-5 flex flex-col gap-2">
            ...
            <ul className="text-xs text-[#71717a] space-y-1 list-disc list-inside">
              <li><strong className="text-[#f4f4f6]">6 Occupied / 5 Reserved / 12 Available</strong> — door utilization is task-derived at the 2026-09-16 ~18:21 PDT snapshot: 6 doors with an in-progress open task (DOCK50, DOCK53, DOCK54, DOCK57, DOCK62, DOCK70), 5 doors holding only a not-started NEW task (DOCK55, DOCK56, DOCK58, DOCK66, DOCK71), 12 doors with no open load/receive task. 11 doors carry an active assignment (47.8%). (Location API dockStatus remains unreliable — it reports far more Bay-4 doors OCCUPIED; task-derived status is authoritative.)</li>
              <li>Open tasks: <strong className="text-[#7c3aed]">2 outbound (LOAD)</strong> / <strong className="text-[#22c55e]">17 inbound (RECEIVE)</strong> = 19 at ~18:21 PDT. 10.5% outbound / 89.5% inbound. All 19 are on Bay-4 doors; the open population was read exhaustively (every one of the 23 Bay-4 doors swept individually for open load tasks and open receive tasks, rows == totalCount on every door).</li>
              <li><strong className="text-[#7c3aed]">Customer mix:</strong> 15 of the 19 open Bay-4 tasks are GURUNANDA, LLC (ORG-655875) — 78.9%; the other 4 are KARAKA, LLC (ORG-585450) — DOCK50 TASK-5368207, DOCK54 TASK-5364490, DOCK55 TASK-5368665, DOCK56 TASK-5369120. Task status: 8 IN_PROGRESS + 11 NEW.</li>
              <li><strong className="text-[#ef4444]">SEVERE ANOMALY — DOCK50 (aging 330d 5h 0m):</strong> TASK-5090739 RECEIVE remains IN_PROGRESS with endTime already set (2025-10-22) — stuck/stale and still aging. Assigned to daira gonzalez. Investigate immediately.</li>
              <li><strong className="text-[#f59e0b]">ANOMALY — DOCK54 (aging 40d 1h 52m):</strong> TASK-5338695 (LOAD) remains IN_PROGRESS with endTime already set (2026-08-10) — stale — while the same door also carries ARNULFO MUNGUIA&apos;s live KARAKA RECEIVE TASK-5364490 plus two NEW GURUNANDA receives (TASK-5369404, TASK-5369031) — four open tasks on one door.</li>
              <li><strong className="text-[#f59e0b]">Two open receive tasks on DOCK50:</strong> TASK-5368207 (RECEIVE IN_PROGRESS, 1d 6h 56m, KARAKA — now also showing an endTime while still IN_PROGRESS) and TASK-5090739 (RECEIVE IN_PROGRESS, 330d 5h 0m, GURUNANDA) — different receipts, two assignees, one door.</li>
              <li><strong className="text-[#22c55e]">Schedule % (today, 2026-09-16 — Wednesday, facility-wide, ~18:21 PDT):</strong> scheduled inbounds received <strong className="text-[#f4f4f6]">{scheduledInboundReceived} of {scheduledInboundOrders} = {pctScheduledInboundReceived.toFixed(1)}%</strong> (receipts whose binding appointmentTimeFrom/To window falls on 2026-09-16; 14 CLOSED + 21 IMPORTED + 14 IN_PROGRESS); scheduled outbound loads loaded <strong className="text-[#f4f4f6]">{scheduledOutboundLoaded} of {scheduledOutboundOrders} = {pctScheduledOutboundLoaded.toFixed(1)}%</strong> (loads whose binding appointmentTimePeriod falls on 2026-09-16; 102 SHIPPED + 1 LOADING + 27 NEW). Both denominators are non-zero this refresh, so both percentages are reported live. Control: the 2026-09-15 receipt window returns 58, matching the prior snapshot.</li>
              ...
              <li><strong className="text-[#f59e0b]">TIMESTAMP BASIS — durations aged task startTime → snapshot instant:</strong> task timestamps are read on the same UTC frame as the snapshot instant (2026-09-17T01:21:40Z), exactly as in every prior snapshot, so the aged durations stay comparable across refreshes.</li>
      ...
      <footer className="border-t border-[#1e1e2a] bg-[#0a0a0f] mt-2">
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between text-xs text-[#71717a]">
          ...
          <span>Last refreshed: September 16, 2026 ~18:21 PDT</span>
        </div>
      </footer>
    </div>
  );
