 ...
 *
 * TASK DATA: Refreshed 2026-09-16 ~19:20 PDT (live WISE/WMS APIs)
 *   Sources:
 ...
 *     - /wms-bam/user/search-by-paging — assignee ids for the open task set
 *
 * SNAPSHOT INSTANT: 2026-09-16 19:20 PDT (America/Los_Angeles), Wednesday.
 * UTC QUERY WINDOW: 2026-09-17T02:19:00Z → 2026-09-17T02:20:30Z.
 ...
 *   string"). Re-verified live this refresh (load-task facility-wide = 27 open vs dockId=564 = 1 open;
 *   comma form → HTTP 400). Every Bay-4 door below was therefore swept individually with the singular
 *   `dockId`. The `statuses` array binds on BOTH load-task and receive-task.
 ...
 *   so durations are aged startTime → 2026-09-17T02:20:28Z — identical to every prior snapshot,
 ...
 * metric in this file was re-pulled from WISE/WMS for the 2026-09-16 ~19:20 PDT snapshot.
 */
...
export const refreshStamp = "Sep 16 ~19:20 PDT";
export const refreshDateLong = "September 16, 2026";
// UTC query window for this snapshot
export const snapshotUtc = "2026-09-17T02:20:28Z";
export const windowUtc = "2026-09-17T02:19:00Z → 2026-09-17T02:20:30Z";

export const doors: DoorRecord[] = [
  // OCCUPIED — door has an in-progress open task (6 doors)
  { door: "DOCK50", status: "Occupied", assignee: "ARNULFO MUNGUIA / daira gonzalez", customer: "KARAKA, LLC / GURUNANDA, LLC", taskIds: ["TASK-5368207", "TASK-5090739"], duration: "330d 5h 59m", anomaly: true },
  { door: "DOCK53", status: "Occupied", assignee: "ARNULFO MUNGUIA", customer: "GURUNANDA, LLC", taskIds: ["TASK-5369859"], duration: "4h 30m", anomaly: false },
  { door: "DOCK54", status: "Occupied", assignee: "ARNULFO MUNGUIA / CANDY MENDEZ", customer: "GURUNANDA, LLC / KARAKA, LLC", taskIds: ["TASK-5338695", "TASK-5369404", "TASK-5369031", "TASK-5364490"], duration: "40d 2h 50m", anomaly: true },
  { door: "DOCK62", status: "Occupied", assignee: "JORGE ANTONIO FRANCO", customer: "GURUNANDA, LLC", taskIds: ["TASK-5365814"], duration: "2d 4h 35m", anomaly: false },
  { door: "DOCK66", status: "Occupied", assignee: "DANIELA GONZALEZ", customer: "GURUNANDA, LLC", taskIds: ["TASK-5369463"], duration: "0h 6m", anomaly: false },
  { door: "DOCK70", status: "Occupied", assignee: "DANIELA GONZALEZ", customer: "GURUNANDA, LLC", taskIds: ["TASK-5370029"], duration: "1h 9m", anomaly: false },
  ...
  { door: "DOCK57", status: "Reserved", assignee: "CANDY MENDEZ", customer: "GURUNANDA, LLC", taskIds: ["TASK-5369084"], duration: null, anomaly: false },
...
// the 2026-09-16 ~19:20 PDT snapshot: 2 LOAD + 16 RECEIVE on 11 doors, 6 distinct assignees)
...
// Mix: 2 LOAD (outbound) + 16 RECEIVE (inbound) = 18 open tasks at Bay 4 doors (2026-09-16
// ~19:20 PDT snapshot).
export const inboundOutboundMix: MixMetric[] = [
  { label: "Outbound", count: 2, total: 18 },
  { label: "Inbound", count: 16, total: 18 },
];
...
// load status LOADED+SHIPPED (loaded). Queried live ~19:20 PDT.
// Inbounds: binding receipt appointmentTimeFrom/To window for the 2026-09-16 local day returns
// 49 scheduled receipts (20 IMPORTED + 15 IN_PROGRESS + 14 CLOSED), of which 14 are CLOSED
// (received) ⇒ 28.6%.
...
// 2026-09-16 (102 SHIPPED + 1 LOADING + 27 NEW), of which 102 are completed (102 SHIPPED + 0 LOADED)
// ⇒ 78.5%.
...
// Open task records from fresh WISE data (Sep 16, 2026 ~19:20 PDT snapshot)
// 18 open tasks: 2 LOAD (outbound) + 16 RECEIVE (inbound)
export const assignments: TaskRecord[] = [
  { taskId: "TASK-5368207", dns: "RECEIVE IN_PROGRESS", customer: "KARAKA, LLC", pieces: "IN_PROGRESS (1d 7h 55m) ⚠ STALE", assignee: "ARNULFO MUNGUIA", door: "DOCK50" },
  { taskId: "TASK-5090739", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (330d 5h 59m) ⚠ STALE", assignee: "daira gonzalez", door: "DOCK50" },
  { taskId: "TASK-5369859", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (4h 30m)", assignee: "ARNULFO MUNGUIA", door: "DOCK53" },
  { taskId: "TASK-5338695", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (40d 2h 50m) ⚠ STALE", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  { taskId: "TASK-5364490", dns: "RECEIVE IN_PROGRESS", customer: "KARAKA, LLC", pieces: "IN_PROGRESS (1d 2h 57m)", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  ...
  { taskId: "TASK-5365814", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (2d 4h 35m)", assignee: "JORGE ANTONIO FRANCO", door: "DOCK62" },
  { taskId: "TASK-5369463", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (0h 6m)", assignee: "DANIELA GONZALEZ", door: "DOCK66" },
  { taskId: "TASK-5370029", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (1h 9m)", assignee: "DANIELA GONZALEZ", door: "DOCK70" },
